  ...
  return (
    <div id="presentationWrapper">
      ...
      <div id="presentationPart">
        <img src="https://www.ebmosaiques.com/ima2/for1.jpg" alt="Ma plus grande réalisation" id="presentationImg" />
        <p id="presentationDescr">
          Nommée "Méditerranée", cette fresque de 9 mètres de longueur et de 2 mètres de hauteur a été posée pour une piscine privée à
          Monaco.
        </p>
        <Link to="/">
          <button className="goToCollection">Voir les photos</button>
        </Link>
      </div>
    </div>
  );
    ...
    <div id="partsWrapper">
      ...
      <div id="collectionParts">
        <div id="horloges" className="part">
          <h3>Mes pendules</h3>
          <img src="https://www.ebmosaiques.com/ima2/ha16p.jpg" alt="Exemple de pendule en mosaïque" className="demoPicture"></img>
          <Link to="/collections/horloges">
            <button className="goToCollection">Voir la collection</button>
          </Link>
        </div>
        <div id="miroirs" className="part">
          <h3>Mes miroirs</h3>
          <img src="https://www.ebmosaiques.com/ima2/mir12m.jpg" alt="Exemple de miroir en mosaïque" className="demoPicture"></img>
          <Link to="/collections/miroirs">
            <button className="goToCollection">Voir la collection</button>
          </Link>
        </div>
        <div id="paintingsAndDecorations" className="part">
          <h3>Mes tableaux</h3>
          <img src="https://www.ebmosaiques.com/ima2/colombm.jpg" alt="Exemple de tableau en mosaïque" className="demoPicture"></img>
          <Link to="/collections/tableaux-et-décors">
            <button className="goToCollection">Voir la collection</button>
          </Link>
        </div>
        <div id="slabs" className="part">
          <h3>Mes dalles de sol</h3>
          <img src="https://www.ebmosaiques.com/ima2/salama3m.jpg" alt="Exemple de dalle en mosaïque" className="demoPicture"></img>
          <Link to="/collections/dalles">
            <button className="goToCollection">Voir la collection</button>
          </Link>
        </div>
        <div id="houseNames" className="part">
          ...
          ></img>
          <Link to="/collections/noms-de-maisons">
            <button className="goToCollection">Voir la collection</button>
          </Link>
        </div>
        <div id="coatOfArms" className="part">
          <h3>Blasons</h3>
          <img src="https://www.ebmosaiques.com/ima2/blanim.jpg" alt="Exemple de blason en mosaïque" className="demoPicture"></img>
          <Link to="/collections/blasons">
            <button className="goToCollection">Voir la collection</button>
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="partContainer grid1">
      ...
      <div id="workshopPart">
        ...
        <Link to="ateliers">
          <button id="workshopPartBtn" className="goToCollection">
            Je veux apprendre
          </button>
        </Link>
      </div>
  ...
  return (
    <div className="partContainer grid2">
      ...
      <div id="eventPart">
        ...
        <Link to="événements">
          <img src="https://www.ebmosaiques.com/ima2/afv1m.jpg" alt="Atelier de mosaïque" id="eventImg"></img>
        </Link>
        <Link to="événements">
          <button id="eventPartBtn" className="goToCollection">
            Voir les événements
          </button>
        </Link>
      </div>
  ...
  return (
    <div className="partContainer grid3">
      ...
      <div id="onTheNewsPart">
        ...
        <Link to="dans-la-presse">
          <button id="onTheNewsPartBtn" className="goToCollection">
            Voir les reportages
          </button>
        </Link>
      </div>
